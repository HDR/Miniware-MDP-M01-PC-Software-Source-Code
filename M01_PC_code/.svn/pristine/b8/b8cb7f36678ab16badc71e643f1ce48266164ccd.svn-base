...
void MainWindow::waveWidgetInit()
{
    ...
    chart->legend()->setFont(QFont(fontName[5]));   //思源黑体 CN Normal
...
//****************************************************
    QFont waveFont = QFont(fontName[4],12);
...
{
    //安装字体
    fontId[0] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/Quantico-Regular.ttf"));
    //qDebug()<<"1:"<<QFontDatabase::applicationFontFamilies(fontId[0]).at(0);
    fontId[1] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/RobotoMono-Regular.ttf"));
    //qDebug()<<"2:"<<QFontDatabase::applicationFontFamilies(fontId[1]).at(0);
    fontId[2] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/Rubik-Regular.ttf"));
    //qDebug()<<"3:"<<QFontDatabase::applicationFontFamilies(fontId[2]).at(0);
    fontId[3] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/SourceHanSansCN-Bold.ttf"));
    //qDebug()<<"4:"<<QFontDatabase::applicationFontFamilies(fontId[3]).at(0);
    fontId[4] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/SourceHanSansCN-Medium.ttf"));
    //qDebug()<<"5:"<<QFontDatabase::applicationFontFamilies(fontId[4]).at(0);
    fontId[5] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/SourceHanSansCN-Normal.ttf"));
    //qDebug()<<"6:"<<QFontDatabase::applicationFontFamilies(fontId[5]).at(0);
    fontId[6] = QFontDatabase::addApplicationFont(QStringLiteral(":/font/font/SourceHanSansCN-Regular.ttf"));
    //qDebug()<<"7:"<<QFontDatabase::applicationFontFamilies(fontId[6]).at(0);
    for(int i=0;i<7;i++)    fontName << QFontDatabase::applicationFontFamilies(fontId[i]).at(0);
    ...
    //控件应用字体
    {
        //groupbox
        {
            ui->groupBox->setFont(QFont(fontName[3],11));
            ui->groupBoxControl->setFont(QFont(fontName[3],11));
            ui->groupBoxDetailed->setFont(QFont(fontName[3],11));
        }
        //label 波形操作
        {
            ui->labelNowTitle->setFont(QFont(fontName[5],22,QFont::Bold));
            ui->labelNowVolta->setFont(QFont(fontName[1],19));
            ui->labelNowElect->setFont(QFont(fontName[1],19));
            ui->label_6->setFont(QFont(fontName[4],12));
            ui->label_18->setFont(QFont(fontName[4],12));
        }
        //label 批量操作
        {
            ui->label->setFont(QFont(fontName[4],11));
            ui->label_2->setFont(QFont(fontName[4],11));
        }
        //label 修改地址
        {
            ui->label_38->setFont(QFont(fontName[4],12));
            ui->label_39->setFont(QFont(fontName[4],12));
            ui->label_55->setFont(QFont(fontName[4],12));

            ui->label_32->setFont(QFont(fontName[4],12));
            ui->label_33->setFont(QFont(fontName[4],12));
            ui->label_34->setFont(QFont(fontName[4],12));
            ui->label_35->setFont(QFont(fontName[4],12));
            ui->label_36->setFont(QFont(fontName[4],12));
            ui->label_37->setFont(QFont(fontName[4],12));
        }
        //label 通道设置
        {
            ui->label_3->setFont(QFont(fontName[4],12));
            ui->label_4->setFont(QFont(fontName[4],12));
            ui->label_5->setFont(QFont(fontName[4],12));
            ui->label_11->setFont(QFont(fontName[4],12));
            ui->labelOutputState_1->setFont(QFont(fontName[4],12));
            ui->labelDefault_1->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->label_45->setFont(QFont(fontName[4],12));
            ui->label_46->setFont(QFont(fontName[4],12));
            ui->label_7->setFont(QFont(fontName[4],12));
            ui->label_8->setFont(QFont(fontName[4],12));
            ui->labelOutputState_2->setFont(QFont(fontName[4],12));
            ui->labelDefault_2->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->label_47->setFont(QFont(fontName[4],12));
            ui->label_48->setFont(QFont(fontName[4],12));
            ui->label_9->setFont(QFont(fontName[4],12));
            ui->label_10->setFont(QFont(fontName[4],12));
            ui->labelOutputState_3->setFont(QFont(fontName[4],12));
            ui->labelDefault_3->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->label_49->setFont(QFont(fontName[4],12));
            ui->label_50->setFont(QFont(fontName[4],12));
            ui->label_12->setFont(QFont(fontName[4],12));
            ui->label_13->setFont(QFont(fontName[4],12));
            ui->labelOutputState_4->setFont(QFont(fontName[4],12));
            ui->labelDefault_4->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->label_51->setFont(QFont(fontName[4],12));
            ui->label_52->setFont(QFont(fontName[4],12));
            ui->label_14->setFont(QFont(fontName[4],12));
            ui->label_15->setFont(QFont(fontName[4],12));
            ui->labelOutputState_5->setFont(QFont(fontName[4],12));
            ui->labelDefault_5->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->label_53->setFont(QFont(fontName[4],12));
            ui->label_54->setFont(QFont(fontName[4],12));
            ui->label_16->setFont(QFont(fontName[4],12));
            ui->label_17->setFont(QFont(fontName[4],12));
            ui->labelOutputState_6->setFont(QFont(fontName[4],12));
            ui->labelDefault_6->setFont(QFont(fontName[2],12,QFont::Bold));
        }
        //label 详细信息
        {
            ui->labelShowNum_1->setFont(QFont(fontName[4],11));
            ui->label_ch1lock->setFont(QFont(fontName[4],11));
            ui->label_19->setFont(QFont(fontName[3],11));
            ui->label_20->setFont(QFont(fontName[3],11));
            ui->label_21->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_1->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_1->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_1->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_1->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_1->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_1->setFont(QFont(fontName[1],11,QFont::Bold));

            ui->labelShowNum_2->setFont(QFont(fontName[4],11));
            ui->label_ch2lock->setFont(QFont(fontName[4],11));
            ui->label_22->setFont(QFont(fontName[3],11));
            ui->label_23->setFont(QFont(fontName[3],11));
            ui->label_24->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_2->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_2->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_2->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_2->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_2->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_2->setFont(QFont(fontName[1],11,QFont::Bold));

            ui->labelShowNum_3->setFont(QFont(fontName[4],11));
            ui->label_ch3lock->setFont(QFont(fontName[4],11));
            ui->label_25->setFont(QFont(fontName[3],11));
            ui->label_29->setFont(QFont(fontName[3],11));
            ui->label_41->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_3->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_3->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_3->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_3->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_3->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_3->setFont(QFont(fontName[1],11,QFont::Bold));

            ui->labelShowNum_4->setFont(QFont(fontName[4],11));
            ui->label_ch4lock->setFont(QFont(fontName[4],11));
            ui->label_26->setFont(QFont(fontName[3],11));
            ui->label_30->setFont(QFont(fontName[3],11));
            ui->label_42->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_4->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_4->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_4->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_4->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_4->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_4->setFont(QFont(fontName[1],11,QFont::Bold));

            ui->labelShowNum_5->setFont(QFont(fontName[4],11));
            ui->label_ch5lock->setFont(QFont(fontName[4],11));
            ui->label_27->setFont(QFont(fontName[3],11));
            ui->label_31->setFont(QFont(fontName[3],11));
            ui->label_43->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_5->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_5->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_5->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_5->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_5->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_5->setFont(QFont(fontName[1],11,QFont::Bold));

            ui->labelShowNum_6->setFont(QFont(fontName[4],11));
            ui->label_ch6lock->setFont(QFont(fontName[4],11));
            ui->label_28->setFont(QFont(fontName[3],11));
            ui->label_40->setFont(QFont(fontName[3],11));
            ui->label_44->setFont(QFont(fontName[3],11));
            ui->labelShowVolat_6->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowElect_6->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowPower_6->setFont(QFont(fontName[1],15,QFont::Bold));
            ui->labelShowInputElect_6->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowInputVolat_6->setFont(QFont(fontName[1],11,QFont::Bold));
            ui->labelShowtemp_6->setFont(QFont(fontName[1],11,QFont::Bold));
        }

        //pushbutton 波形操作
        {
            ui->pushButtonCleanWave->setFont(QFont(fontName[4],12));
            ui->pushButtonSaveWave->setFont(QFont(fontName[4],12));
            ui->pushButtonWaitWave->setFont(QFont(fontName[4],12));
        }
        //pushbutton 通道设置
        {
            ui->pushButtonSetOutputState_1->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_1->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_1->setFont(QFont(fontName[4],12));

            ui->pushButtonSetOutputState_2->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_2->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_2->setFont(QFont(fontName[4],12));

            ui->pushButtonSetOutputState_3->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_3->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_3->setFont(QFont(fontName[4],12));

            ui->pushButtonSetOutputState_4->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_4->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_4->setFont(QFont(fontName[4],12));

            ui->pushButtonSetOutputState_5->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_5->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_5->setFont(QFont(fontName[4],12));

            ui->pushButtonSetOutputState_6->setFont(QFont(fontName[4],12));
            ui->pushButtonSetVoltageDefault_6->setFont(QFont(fontName[4],12));
            ui->pushButtonSetElectDefault_6->setFont(QFont(fontName[4],12));
        }
        //pushbutton 批量操作
        {
            ui->pushButtonSetAllV->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAllI->setFont(QFont(fontName[4],12));
            ui->pushButtonOpenAll->setFont(QFont(fontName[4],12));
            ui->pushButtonCloseAll->setFont(QFont(fontName[4],12));
            ui->pushButtonRGB->setFont(QFont(fontName[4],12));      //未使用
        }
        //pushbutton 修改地址
        {
            ui->pushButtonReadAllAddrToPc->setFont(QFont(fontName[4],12));
            ui->pushButtonStartAutoMach->setFont(QFont(fontName[4],12));

            ui->pushButtonDelAddr_1->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_1->setFont(QFont(fontName[4],12));
            ui->pushButtonDelAddr_2->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_2->setFont(QFont(fontName[4],12));
            ui->pushButtonDelAddr_3->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_3->setFont(QFont(fontName[4],12));
            ui->pushButtonDelAddr_4->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_4->setFont(QFont(fontName[4],12));
            ui->pushButtonDelAddr_5->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_5->setFont(QFont(fontName[4],12));
            ui->pushButtonDelAddr_6->setFont(QFont(fontName[4],12));
            ui->pushButtonSetAddr_6->setFont(QFont(fontName[4],12));
        }

        //doublespinbox 通道设置
        {
            ui->doubleSpinBoxSetDefautVoltage_1->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_1->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->doubleSpinBoxSetDefautVoltage_2->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_2->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->doubleSpinBoxSetDefautVoltage_3->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_3->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->doubleSpinBoxSetDefautVoltage_4->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_4->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->doubleSpinBoxSetDefautVoltage_5->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_5->setFont(QFont(fontName[2],12,QFont::Bold));

            ui->doubleSpinBoxSetDefautVoltage_6->setFont(QFont(fontName[2],12,QFont::Bold));
            ui->doubleSpinBoxSetDefautElect_6->setFont(QFont(fontName[2],12,QFont::Bold));
        }
        //doublespinbox 批量操作
        {
            ui->doubleSpinBoxSetALLV->setFont(QFont(fontName[2],14,QFont::Bold));
            ui->doubleSpinBoxSetALLI->setFont(QFont(fontName[2],14,QFont::Bold));
        }

        //lineedit 地址频率
        {
            ui->lineEditAddr_1->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_1->setFont(QFont(fontName[2],12));

            ui->lineEditAddr_2->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_2->setFont(QFont(fontName[2],12));

            ui->lineEditAddr_3->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_3->setFont(QFont(fontName[2],12));

            ui->lineEditAddr_4->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_4->setFont(QFont(fontName[2],12));

            ui->lineEditAddr_5->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_5->setFont(QFont(fontName[2],12));

            ui->lineEditAddr_6->setFont(QFont(fontName[2],12));
            ui->lineEditFreq_6->setFont(QFont(fontName[2],12));
        }

        //tabWidget
        {
            ui->tabWidgetSetVI->setFont(QFont(fontName[0],10,QFont::Bold));
            ui->tabWidgetAddr->setFont(QFont(fontName[6],11));
        }

        //菜单栏
        {
            ui->menuBar->setFont(QFont(fontName[4],10));

            ui->actionScanCom->setFont(QFont(fontName[4],10));
            ui->action->setFont(QFont(fontName[4],10));

            ui->actionchina->setFont(QFont(fontName[4],10));
            ui->actionEnglish->setFont(QFont(fontName[4],10));

            ui->actionVer->setFont(QFont(fontName[4],10));
            ui->actionUptoDFU->setFont(QFont(fontName[4],10));
        }
    }
...
void MainWindow::on_actionVer_triggered(bool checked)
{
    ...
    verDialog->setFont(QFont(fontName[6]));
