    ...
    ui(new Ui::switchCom)
{
    ...
    ui->label->setFont(QFont(fontName,12));

    ui->pushButtonOpenCom->setFont(QFont(fontName,9));
    ui->pushButtonScanCom->setFont(QFont(fontName,9));

    ui->comboBoxCom->setFont(QFont(fontName,9));
